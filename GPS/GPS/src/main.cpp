...
{
  Serial.begin(115200);
  GPS_Serial.begin(GPSBaud, SERIAL_8N1, 
                  RXPin,TXPin,false);
...
//
  ...
  else if (gps.time.isUpdated())
  {
    ...
    Serial.print(gps.time.value());
    Serial.print(F(" Hour="));
    Serial.print(gps.time.hour()<16 ? gps.time.hour()+8 : gps.time.hour()-16);
    Serial.print(F(" Minute="));
    Serial.print(gps.time.minute());
    Serial.print(F(" Second="));
    Serial.print(gps.time.second());
  ...
  else if (millis() - last > 5000)
  {
    ...
    {
      static const double HOME_LAT = 30.625932, HOME_LON = 104.070416;
